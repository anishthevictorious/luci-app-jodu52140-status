...
```sh
cd /tmp && uclient-fetch -O luci-app-jodu52140-status-3.0-r1.apk https://github.com/anishthevictorious/luci-app-jodu52140-status/releases/download/3.0-r1/luci-app-jodu52140-status-3.0-r1.apk && apk add --allow-untrusted ./luci-app-jodu52140-status-*.apk
```
